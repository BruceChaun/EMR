...
javac -classpath lib/apache-commons-lang.jar:lib/commons-configuration-1.9.jar:lib/commons-logging-1.2.jar:lib/hadoop-core-1.2.1.jar:lib/hadoop-mapreduce-client-core-0.23.1.jar:lib/IKAnalyzer2012_u6.jar:lib/jackson-all-1.9.0.jar:lib/lucene-core-3.6.0.jar:lib/mysql-connector-java-5.1.23-bin.jar -d build/ src/com/emr/dbutil/IndexDB.java src/com/emr/nlp/NLP.java src/com/emr/mapred/Index.java src/com/emr/mapred/EMRChain.java 
